...
* [Global Configurations](user-guide/global-configurations/README.md)
  ...
  * [Catalog](user-guide/global-configurations/catalog-framework.md)
...
* [Applications](user-guide/applications.md)
  ...
  * [App Configuration](user-guide/creating-application/README.md)
    ...
    * [Base Configurations](user-guide/creating-application/base-config/README.md)
      ...
      * [Types of Deployment Templates](user-guide/creating-application/base-config/deployment-template-types/README.md)
        * [Deployment](user-guide/creating-application/base-config/deployment-template-types/deployment.md)
        * [Rollout Deployment](user-guide/creating-application/base-config/deployment-template-types/rollout-deployment.md)
        * [Job and Cronjob](user-guide/creating-application/base-config/deployment-template-types/job-and-cronjob.md)
        * [StatefulSets](user-guide/creating-application/base-config/deployment-template-types/statefulset.md)  
