...
| **Role**  | Select one of the [roles](#kubernetes-resources-permissions) to which you want to give permission to the user and click `Done`:<ul><li>`View`</li></ul> <ul><li>`Admin`</li></ul>  |
