...
:::info 
Devtron also gives you the option of partial cloning. It increases the cloning speed of your [code repository](../../reference/glossary.md#repo), thus reducing the [build time](../../reference/glossary.md#build-pipeline) during the [CI process](../deploying-application/triggering-ci.md).
:::
