...
* Select the namespace from the drop-down list which you have added in the [Clusters & Environments](../global-configurations/cluster-and-environments.md#add-environment-to-a-cluster) section.
